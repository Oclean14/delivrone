...
for drone in drones:
	...
	el = Drone(drone["name"], {'x': drone["homeLocation"]["x"], 'y':drone["homeLocation"]["y"]}, {'x': drone["position"]["x"], 'y':drone["position"]["y"]}, drone["failureFrequency"], drone["averageSpeed"], battery)
...
for station in stations:
	...
	el = Station(station["name"], { 'x': station["position"]["x"], 'y': station["position"]["y"] }, chargingBatteries, chargedBatteries, station["storageCapacity"], station["chargingTime"], station["chargingSlots"], station["changeDuration"], station["failureFrequency"])
